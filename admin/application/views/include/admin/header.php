...
<head>
        ...
        <!-- Title -->
        <title>Ram Doot International School
        </title>
            ...
            <div class="navbar">
                <div class="navbar-inner container">
                    <div class="row">
                       ...
                       <div class="col-md-3"><a href="index.html" style="padding-top:20px;" class="waves-effect waves-button waves-classic sidebar-toggle"><span style="font-size:16px;">Ram Doot International School</span></a></div>
                       <div class="col-md-4">
